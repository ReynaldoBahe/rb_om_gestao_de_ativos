...
.left-panel { padding: 15px 5px; text-align: center; }

/* Ajuste proporcional da rede para caber sem rolar a tela */
.network-container { position: relative; width: 330px; height: 250px; margin: 0 auto 20px auto; }
...
/* Tipografia do painel esquerdo com peso e clareza visual */
...
/* Limita e centraliza a largura do formulário na coluna direita */
.right-wrapper { max-width: 420px; margin: 0 auto; padding-top: 10px; }
...
/* Customização dos inputs com foco forte nas letras digitadas */
...
input[data-testid="stTextInputRootElementroot"], input { background-color: transparent !important; color: #FFFFFF !important; font-weight: 600 !important; font-size: 17px !important; }
