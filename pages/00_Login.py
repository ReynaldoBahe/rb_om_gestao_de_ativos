...
.node-center span {
    ...
    color: #8AB4F8; margin-top: 2px; letter-spacing: 0.5px;
}
.node-sat {
    ...
    box-shadow: 0 6px 15px rgba(0,0,0,0.5); z-index: 5;
}
...
/* Lado direito — wrapper centralizado */
.right-wrapper {
    max-width: 400px;
    margin: 0 auto;
    padding-top: 0;
